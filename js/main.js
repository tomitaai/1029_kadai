...
$(window).on("keydown", function (e) {
    ...
    if (
        pos_item14.left >= pos_drum.left + 37.5 &&
    ...
    if (
        pos_item15.left >= pos_drum.left + 37.5 &&
    ...
    if (
        pos_item16.left >= pos_drum.left + 37.5 &&
    ...
    if (
        pos_item17.left >= pos_drum.left + 37.5 &&
    ...
    if (
        pos_item18.left >= pos_drum.left + 37.5 &&
    ...
    if (
        pos_item19.left >= pos_drum.left + 37.5 &&
    ...
    if (
        pos_item20.left >= pos_drum.left + 37.5 &&
    ...
    if (
        pos_item21.left >= pos_drum.left + 37.5 &&
    ...
    if (
        pos_item22.left >= pos_drum.left + 37.5 &&
    ...
    if (
        pos_item23.left >= pos_drum.left + 37.5 &&
    ...
    if (
        pos_item24.left >= pos_drum.left + 37.5 &&
    ...
    if (
        pos_item25.left >= pos_drum.left + 37.5 &&
